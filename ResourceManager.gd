...
const BASE_COST_PER_SECOND_INCREASE_RATE = 0.25 # How fast base_cost_per_second_increases
...
const ROOT_CONSTRUCTION_COST_MULTIPLIER = 0.004 # Multiplier for the cost of building new roots
